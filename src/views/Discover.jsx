    ...
    <div>
      ...
      {showAll ? <>
        <div className={style.discoverViewAll}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-5 m-12 xl:mx-32" >
            {errorResults ? (
        <div className="col-span-full text-center">
        <p className="text-red-500">{errorResults.message}</p>
            </div>
            ) : loading ? (
        <div role="status" className="flex items-start justify-center h-screen mt-10">
